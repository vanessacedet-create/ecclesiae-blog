      ...
      <Link href={`/posts/${id}`} className="group block">
        <article className="relative bg-burgundy text-cream overflow-hidden gold-hover">
          ...
          <div className="relative p-10 md:p-14">
            {category && (
              <span className="inline-block w-fit font-display text-xs tracking-[0.3em] uppercase text-gold font-semibold mb-4 border border-gold/30 px-3 py-1">
                {category}
              </span>
            )}
      ...
      <Link href={`/posts/${id}`} className="group block h-full">
        <article className="h-full flex flex-col bg-white border border-gray-200 hover:border-burgundy/30 transition-all duration-300 overflow-hidden">
          ...
          <div className="p-5 flex-1 flex flex-col">
            {category && (
              <span className="inline-block w-fit font-display tracking-[0.2em] uppercase text-burgundy font-semibold mb-2 border border-burgundy/25 px-2.5 py-0.5" style={{ fontSize: '10px' }}>
                {category}
              </span>
            )}
      ...
      <Link href={`/posts/${id}`} className="group block h-full">
        <article className="h-full bg-white border border-gray-200 hover:border-burgundy/30 transition-all duration-300 overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            {category && (
              <span className="inline-block w-fit font-display text-xs tracking-[0.25em] uppercase text-burgundy font-semibold mb-3 border border-burgundy/25 px-3 py-1">
                {category}
              </span>
            )}
      ...
      <Link href={`/posts/${id}`} className="group block">
        <article className="flex gap-5 bg-white border border-gray-200 hover:border-burgundy/30 transition-all duration-300 overflow-hidden">
          ...
          <div className="flex-1 py-4 pr-5">
            {category && (
              <span className="inline-block w-fit font-display text-xs tracking-[0.2em] uppercase text-burgundy font-semibold mb-1 border border-burgundy/25 px-3 py-1">
                {category}
              </span>
            )}
      ...
      <Link href={`/posts/${id}`} className="group block h-full">
        <article className="h-full flex flex-col bg-white border border-gray-200 hover:border-burgundy/30 transition-all duration-300 overflow-hidden">
          ...
          <div className="p-4 flex-1 flex flex-col">
            {category && (
              <span className="inline-block w-fit font-display text-xs tracking-[0.2em] uppercase text-burgundy font-semibold mb-2 border border-burgundy/25 px-3 py-1">{category}</span>
            )}
